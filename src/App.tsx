              ...
              <>
                ...
                >
                  ...
                  <div className="px-5 py-5 space-y-4 overflow-y-auto">
                    ...
                    <a href={`https://api.whatsapp.com/send?phone=${selectedCrmContact.phone.replace(/\D/g,'')}&text=${encodeURIComponent('Hola ' + selectedCrmContact.name.split(' ')[0] + '! Te esperamos en Café Central 🎉')}`} target="_blank" rel="noopener noreferrer" className="flex items-center justify-center gap-2 w-full py-3.5 bg-green-500 text-white font-bold text-sm rounded-2xl active:scale-[0.97] transition-transform mt-2">
